...
if(in_array($fileActuaExt , $allowed)){
    if($fileError === 0){
        if($fileSize<5000000){
               ...
               $fileDestination = "../user_image/".$imageFullName;
               echo $fileDestination;

        include_once"../utils/connection.php";
       // if(empty($imageFile)|| empty($imageDesc)){
            //header("location: ../view/user-edit.php?upload=empty");
           // exit();
      ...
      //  }else{
            ...
            if(!mysqli_stmt_prepare($stmt,$sql)){
                ...
                if(!mysqli_stmt_prepare($stmt , $sql)){
                    ...
                    mysqli_stmt_bind_param($stmt , "si",$imageFullName ,$user_id);
                    mysqli_stmt_execute($stmt);
                    $file_pointer ="../user_image/".$imageFullName;
