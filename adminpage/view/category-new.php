                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="../controller/createCategory.php" method="POST" class="form-horizontal">
                                    <div class="col-xl-8 order-xl-1">
                                        <div class="card bg-secondary shadow">
                                            <div class="card-header bg-white border-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="cate_name" class="form-control form-control-alternative" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <input name="createCate" type="submit" value="Create" class="btn1">
                                                <hr class="my-4">
                                                <!-- Description -->
