          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body card-block">
                ...
                <form action="../controller/createUser.php" method="POST"  class="form-horizontal">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="email" name="email"  class="form-control form-control-alternative"placeholder=expamle@example.com value="">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group focused">
                                ...
                                <input name="user_name" type="text"class="form-control form-control-alternative" value="">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group focused">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group focused">
                                ...
                                <input name="address" id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="" type="text">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group focused">
                                ...
                                <select name="status" id="role" class="form-control form-control-alternative" value=" ">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                ...
                                <input name="pass" type="password" id="pass" class="form-control form-control-alternative" value=""><br><br>
