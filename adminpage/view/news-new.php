          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body card-block">
                ...
                <form action="../controller/createnews.php" method="POST"  class="form-horizontal">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="input-email">News Name</label>
                                <input type="text" name="news_name"  class="form-control form-control-alternative"value="">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group focused">
                                ...
                                <input name="news_title" type="text"class="form-control form-control-alternative" value="">
                              </div>
                              <div class="form-group">
                                <label class="form-control-label" for="input-email">Category  </label>
                                <input type="number" name="caten_id" placeholder="(please enter code Category News )" class="form-control form-control-alternative"value="">
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group focused">
                                ...
                                <textarea name="news_content"  rows="40" cols="50" id="input-content" class="form-control form-control-alternative" ></textarea>
                              </div>
                            </div>
                          </div>
