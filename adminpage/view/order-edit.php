                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="../controller/updateOrder.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group focused">
                                                                            ...
                                                                            <input name="order_id" type="text" id="input-ordername" class="form-control form-control-alternative" value="<?php echo $row["order_id"]; ?>" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label class="form-control-label" for="input-email">Email </label>
                                                                            <input type="email" name="order_email" id="input-email" class="form-control form-control-alternative" value="<?php echo $row["email_order"]; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group focused">
                                                                            ...
                                                                            <input type="text" name="fullname" id="input-first-name" class="form-control form-control-alternative" value="<?php echo $row["fullname"]; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group focused">
                                                                            <label class="form-control-label" for="input-last-name">Phone</label>
                                                                            <input type="number" id="input-last-name" name="phone" class="form-control form-control-alternative" value="<?php echo $row["phone"]; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group focused">
                                                                            <label class="form-control-label" for="input-last-name">Total</label>
                                                                            <input type="number" id="input-last-name" name="total" class="form-control form-control-alternative" value="<?php echo $row["total"]; ?>" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group focused">
                                                                            ...
                                                                            <input id="input-address" name="order_address" class="form-control form-control-alternative" value="<?php echo $row["address_order"]; ?>" type="text">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group focused">
                                                                            ...
                                                                            <input type="number" id="input-country" name="status_order" class="form-control form-control-alternative" value="<?php echo $row["status_order"]; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label class="form-control-label" for="input-country">User ID</label>
                                                                            <input type="number" name="user_id" value="<?php echo $row["user_id"]; ?>" class="form-control form-control-alternative" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
