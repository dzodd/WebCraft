                  ...
                  <div class="pl-lg-4">
                      <div class="row">
                       <div class="col-lg-6">
                        ...
                        <label class="form-control-label" for="input-username">News ID</label>
                        <input   type="text" id="input-username" class="form-control form-control-alternative" value="<?php echo $row["news_id"]; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Title </label>
                        <input type="email" id="input-email" class="form-control form-control-alternative" value="<?php echo $row["news_title"]; ?>" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative"  value="<?php echo $row["news_name"]; ?>" readonly>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <textarea  rows="40" cols="50" id="input-content" class="form-control form-control-alternative" readonly> <?php echo $row["news_content"]; ?></textarea>
                      </div>
                    </div>
                  </div>
